                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        >
                            ...
                            >
                                Nos Prestations
                                <svg 
                                    className={`w-4 h-4 transition-transform ${isPrestationsOpen ? 'rotate-180' : ''}`} 
                                    fill="none" 
                                    stroke="currentColor" 
                                    viewBox="0 0 24 24"
                                >
                            ...
                            {/* Dropdown Menu */}
                            {isPrestationsOpen && (
                                <div className="absolute top-full left-0 mt-2 w-72 bg-white rounded-lg shadow-2xl py-2 z-50 max-h-96 overflow-y-auto">
                        ...
                        <div className="flex flex-col space-y-4">
                            ...
                            <div>
                                ...
                                >
                                    Nos Prestations
                                    <svg 
                                        className={`w-4 h-4 transition-transform ${isMobilePrestationsOpen ? 'rotate-180' : ''}`} 
                                        fill="none" 
                                        stroke="currentColor" 
                                        viewBox="0 0 24 24"
                                    >
                                    ...
                                    <div className="mt-2 ml-4 space-y-2 max-h-60 overflow-y-auto">
                                        {prestations.map((prestation, index) => (
                                            <Link
                                                key={index}
                                                href={`/prestations/${prestation.slug}`}
                                                className="block text-gray-600 hover:text-blue-600 text-sm transition-colors py-1"
                                            >
                                                {prestation.title}
                                            </Link>
                                        ))}
