...
export default function StreetMarketing() {
    const images = [1, 2, 3];
    ...
    return (
        <>
            <Head title="Street Marketing et Publicité - Stoon Events" />
            <Navbar />
            <SocialSidebar />
            <WhatsAppButton />
            ...
            <div className="min-h-screen bg-gray-50">
                ...
                <section className="relative h-[60vh] md:h-[70vh] overflow-hidden">
                    <img 
                        src="/assets/images/nosPrestations/street_marketing_publicite/1.jpeg" 
                    ...
                    <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 max-w-7xl">
                        <div className="prose prose-lg max-w-none">
                            <p className="text-xl text-gray-700 leading-relaxed mb-6">
                                Le street marketing permet de se rapprocher de la clientèle. L’objectif est de pouvoir favoriser les échanges, programmer des événements et de créer une communication de proximité, Stoon events s’occupe de tous les moyens possible pour s’adapter à votre budget.
                            </p>
                                ...
                                >
                                    {images.map((num) => (
                                        <div key={num} className="w-full flex-shrink-0">
                                            <img 
                                                src={`/assets/images/nosPrestations/street_marketing_publicite/${num}.jpeg`}
                                                alt={`Street Marketing ${num}`}
