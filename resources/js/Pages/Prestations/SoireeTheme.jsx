...
export default function SoireeTheme() {
    ...
    return (
        <>
            <Head title="Soirées à Thème - Stoon Events" />
            <Navbar />
            <SocialSidebar />
            <WhatsAppButton />
            ...
            <div className="min-h-screen bg-gray-50">
                ...
                <section className="relative h-[60vh] md:h-[70vh] overflow-hidden">
                    <img 
                        src="/assets/images/nosPrestations/soiree_a_theme/1.jpeg" 
                        alt="Soirées à Thème" 
                                ...
                                >
                                    {images.map((num) => (
                                        <div key={num} className="w-full flex-shrink-0">
                                            <img 
                                                src={`/assets/images/nosPrestations/soiree_a_theme/${num}.jpeg`}
                                                alt={`Soirées à Thème ${num}`}
