...
export default function Sensibilisation() {
    ...
    return (
        <>
            <Head title="Campagne de Sensibilisation - Stoon Events" />
            <Navbar />
            <SocialSidebar />
            <WhatsAppButton />
            ...
            <div className="min-h-screen bg-gray-50">
                ...
                <section className="relative h-[60vh] md:h-[70vh] overflow-hidden">
                    <img 
                        src="/assets/images/nosPrestations/campagne_de_sensibilisation/1.jpeg" 
                                ...
                                >
                                    {images.map((num) => (
                                        <div key={num} className="w-full flex-shrink-0">
                                            <img 
                                                src={`/assets/images/nosPrestations/campagne_de_sensibilisation/${num}.jpeg`}
                                                alt={`Campagne de Sensibilisation ${num}`}
