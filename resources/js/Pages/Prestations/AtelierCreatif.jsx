...
export default function AtelierCreatif() {
    ...
    return (
        <>
            <Head title="Ateliers Créatifs - Stoon Events" />
            <Navbar />
            <SocialSidebar />
            <WhatsAppButton />
...
Découvrez des ateliers spéciaux à développer les capacités sensorielles et artistiques de votre enfant pour découvrir ses talents.                            </p>
                                ...
                                >
                                    {images.map((num) => (
                                        <div key={num} className="w-full flex-shrink-0">
                                            <img 
                                                src={`/assets/images/nosPrestations/atelier_creatifs/${num}.jpeg`}
                                                alt={`Ateliers Créatifs ${num}`}
