...
export default function EvenementsFamiliaux() {
    const images = [3, 2, 1];
    ...
    return (
        <>
            <Head title="Événements Familiaux - Stoon Events" />
            <Navbar />
            <SocialSidebar />
            <WhatsAppButton />
            ...
            <div className="min-h-screen bg-gray-50">
                ...
                <section className="relative h-[60vh] md:h-[70vh] overflow-hidden">
                    <img 
                        src="/assets/images/nosPrestations/evenements_familiaux/3.jpeg" 
                                ...
                                >
                                    {images.map((num) => (
                                        <div key={num} className="w-full flex-shrink-0">
                                            <img 
                                                src={`/assets/images/nosPrestations/evenements_familiaux/${num}.jpeg`}
                                                alt={`Événements Familiaux ${num}`}
