...
export default function Festival() {
    ...
    return (
        <>
            <Head title="Festival - Stoon Events" />
            <Navbar />
            <SocialSidebar />
            <WhatsAppButton />
            ...
            <div className="min-h-screen bg-gray-50">
                ...
                <section className="relative h-[60vh] md:h-[70vh] overflow-hidden">
                    <img 
                        src="/assets/images/nosPrestations/festival/1.jpeg" 
                        alt="Festival" 
...
Stoon events s’occupe de l’organisation du festival comme l’éclairage et sonorisation aussi la scène avec structure et les écrans géants sans oublié la décoration et la partie de communication avec les artistes.                             </p>
                                ...
                                >
                                    {images.map((num) => (
                                        <div key={num} className="w-full flex-shrink-0">
                                            <img 
                                                src={`/assets/images/nosPrestations/festival/${num}.jpeg`}
                                                alt={`Festival ${num}`}
